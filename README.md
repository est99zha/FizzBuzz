...
class FizzBuzz {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= 100; i++) { /* in python is: for i in range(1, 101): */

            // Find out which numbers divide i.
            boolean divisibleBy3 = i % 3 == 0; /* boolean ... (Java); if ...: (Python) */
            boolean divisibleBy5 = i % 5 == 0;

            // Print our appropriate result.
            if (divisibleBy3 && divisibleBy5) { /* and in Python is just and, in java is && */

                System.out.println("Fizz Buzz"); /* System.out.println(...) (Java); print(...) (Python) */
